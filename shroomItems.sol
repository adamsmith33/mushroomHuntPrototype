...
contract shroomItems is ERC1155, Ownable{
    ...
    uint256 public constant LEAF = 1;
    uint256 public constant MINI = 2;
    uint256 public constant STICK = 3;

    string[] public accessories = ["NONE", "STICK", "TATTOO"];

    mapping(address => bool) public isApproved;

    constructor () ERC1155("https://gateway.pinata.cloud/ipfs/QmeyL9P99jLV4DfFQVFrXX156696JAPjrbiGWgQnKJAAKH/{id}.json") {
        _mint(msg.sender, LEAF, 3, "");
        _mint(msg.sender, MINI, 3, "");
    ...
    function uri(uint256 tokenId) override public pure returns(string memory){
        return(
            string(abi.encodePacked(
                "https://gateway.pinata.cloud/ipfs/QmeyL9P99jLV4DfFQVFrXX156696JAPjrbiGWgQnKJAAKH/",
